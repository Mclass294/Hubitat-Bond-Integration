 ...
 *  Version 1.1.0
 *
 *  Based on the original work by Dominick Meglio
 *  Original repository:
 ...
 *
 *  Original Copyright 2019-2020 Dominick Meglio
 *
 *  Revision History
 *  2026.07.04 - v1.1.0 - Added position (0/100) events for Motorized Shades to
 *                        improve compatibility with Hubitat Easy Dashboard.
 *  2020.06.28 - Added toggle command to all devices and support for multiple Smart by BOND devices.
 *  2020.04.21 - Added better logging for connection issues.
 *  2020.04.13 - Added stop command to motorized shades.
 *  2020.03.23 - Added the ability to fix device state when it's is out of sync.
 *  2020.02.01 - Fixed Smart by BOND device discovery.
 *  2020.01.18 - Added setPosition support for motorized shades.
 */

definition(
    name: "BOND Home Integration Community Edition",
    namespace: "dcm.bond",
    author: "Dominick Meglio, Neil McLaren",
    description: "Connects to BOND Home hub",
    category: "My Apps",
    iconUrl: "https://s3.amazonaws.com/smartapp-icons/Convenience/Cat-Convenience.png",
    iconX2Url: "https://s3.amazonaws.com/smartapp-icons/Convenience/Cat-Convenience@2x.png",
    iconX3Url: "https://s3.amazonaws.com/smartapp-icons/Convenience/Cat-Convenience@2x.png",
	documentationLink: "https://github.com/mclass/Hubitat-Bond-Integration")
